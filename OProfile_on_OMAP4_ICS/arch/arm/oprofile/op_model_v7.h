...
#define CPU_COUNTER(cpu, counter)	(counter)
...
#define	CNTENS_MASK	0x8000003f	/* Mask for writable bits */
...
#define	CNTENC_MASK	0x8000003f	/* Mask for writable bits */
...
#define	INTENS_MASK	0x8000003f	/* Mask for writable bits */

/*
 * EVTSEL: Event selection reg
 */
#define	EVTSEL_MASK	0xff		/* Mask for writable bits */
...
#define FLAG_P3		(1 << 3)
#define FLAG_C		(1 << 31)
#define	FLAG_MASK	0x8000003f	/* Mask for writable bits */
